...
const PageContent = ({category}) => {
    ...
    const categoryData = {
        uiux: [
            ...
            {id: 'maria', label: 'Maria', image: '/assets/ui-maria.svg', category: 'uiux', type: 'Narration interactive Musba'},
            ...
            {id: 'reserve', label: 'La réserve - Musba', image: '/assets/ui-reserve.svg', category: 'uiux', type: 'Narration interactive Musba'},
        ],
        photo: [
        ...
        illu: [
            {id: 'allo', label: 'Allô à l\'huile', image: '/assets/illu-allo.webp', category: 'illu', type: 'Design coque de téléphone'},
            {id: 'logommi', label: 'Logo MMI', image: '/assets/illu-logommi.webp', category: 'illu', type: 'Logo'},
            ...
            {id: 'pieuvre', label: 'Pieuvre', image: '/assets/illu-pieuvre.webp', category: 'illu', type: 'Dessin numérique'},
            {id: 'cocktails', label: 'Cocktails', image: '/assets/illu-cocktails.webp', category: 'illu', type: 'Dessin numérique'},
        ],
        autre: [
            {
                id: 'mainslibres',
                label: 'Les Mains Libres',
                image: '/assets/mainslibres.webp',
                category: 'autre',
                type: 'Direction Artistique'
            },
            {
                id: 'motion',
                label: 'Distortions cognitives',
                image: '/assets/motion.webp',
                category: 'autre',
                type: 'Motion Design'
            },
        ],
